...
frappe.ui.form.on('Project Initiation', {
    ...
    profit_0: function (frm) {
        ...
        set_value(cur_frm, "markup_0", (markup_0 * 100));
        set_value(cur_frm, "margin_0", (margin_0 * 100));
        refresh_general_pricing(frm);
    },
    profit_1: function (frm) {
        ...
        set_value(cur_frm, "markup_1", (markup_1 * 100));
        set_value(cur_frm, "margin_1", (margin_1 * 100));
        refresh_general_pricing(frm);
    },
    profit_2: function (frm) {
        ...
        set_value(cur_frm, "markup_2", (markup_2 * 100));
        set_value(cur_frm, "margin_2", (margin_2 * 100));
        refresh_general_pricing(frm);
    },
    profit_3: function (frm) {
        ...
        set_value(cur_frm, "markup_3", (markup_3 * 100));
        set_value(cur_frm, "margin_3", (margin_3 * 100));
        refresh_general_pricing(frm);
    },
    profit_4: function (frm) {
        ...
        set_value(cur_frm, "markup_4", (markup_4 * 100));
        set_value(cur_frm, "margin_4", (margin_4 * 100));
        refresh_general_pricing(frm);
    },
    profit_5: function (frm) {
        ...
        set_value(cur_frm, "markup_5", (markup_5 * 100));
        set_value(cur_frm, "margin_5", (margin_5 * 100));
        refresh_general_pricing(frm);
    },
    profit_6: function (frm) {
        ...
        set_value(cur_frm, "markup_6", (markup_6 * 100));
        set_value(cur_frm, "margin_6", (margin_6 * 100));
        refresh_general_pricing(frm);
    },
    profit_7: function (frm) {
        ...
        set_value(cur_frm, "markup_7", (markup_7 * 100));
        set_value(cur_frm, "margin_7", (margin_7 * 100));
        refresh_general_pricing(frm);
    },
    profit_8: function (frm) {
        ...
        set_value(cur_frm, "markup_8", (markup_8 * 100));
        set_value(cur_frm, "margin_8", (margin_8 * 100));
        refresh_general_pricing(frm);
    },
    profit_9: function (frm) {
        ...
        set_value(cur_frm, "markup_9", (markup_9 * 100));
        set_value(cur_frm, "margin_9", (margin_9 * 100));
        refresh_general_pricing(frm);
    },
    profit_10: function (frm) {
        ...
        set_value(cur_frm, "markup_10", (markup_10 * 100));
        set_value(cur_frm, "margin_10", (margin_10 * 100));
        refresh_general_pricing(frm);
    },
    profit_11: function (frm) {
        ...
        set_value(cur_frm, "markup_11", (markup_11 * 100));
        set_value(cur_frm, "margin_11", (margin_11 * 100));
        refresh_general_pricing(frm);
    },
    profit_12: function (frm) {
        ...
        set_value(cur_frm, "markup_12", (markup_12 * 100));
        set_value(cur_frm, "margin_12", (margin_12 * 100));
        refresh_general_pricing(frm);
    },
    profit_13: function (frm) {
        ...
        set_value(cur_frm, "markup_13", (markup_13 * 100));
        set_value(cur_frm, "margin_13", (margin_13 * 100));
        refresh_general_pricing(frm);
    },
    profit_14: function (frm) {
        ...
        set_value(cur_frm, "markup_14", (markup_14 * 100));
        set_value(cur_frm, "margin_14", (margin_14 * 100));
        refresh_general_pricing(frm);
    },
    profit_15: function (frm) {
        ...
        set_value(cur_frm, "markup_15", (markup_15 * 100));
        set_value(cur_frm, "margin_15", (margin_15 * 100));
        refresh_general_pricing(frm);
    },
    vat: function (frm) {
...
frappe.ui.form.on('Project Costing Schedule', {
    type_of_cost: function (frm, cdt, cdn) {
        ...
        set_value_model(cdt, cdn, "scope_item", );
        set_value_model(cdt, cdn, "scope_item_cost_value", 0);
        set_value_model(cdt, cdn, "no_contracts", );
        set_value_model(cdt, cdn, "po_contract_extimated_cost", );
        set_value_model(cdt, cdn, "vendor", );
        set_value_model(cdt, cdn, "last_date", );
