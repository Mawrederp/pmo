...
frappe.ui.form.on('Project Initiation', {
    ...
    profit_0: function (frm) {
        ...
        if (cur_frm.doc.profit_0 && cur_frm.doc.profit_0 != 0) {
            if (cur_frm.doc.cost_0 + cur_frm.doc.risk_contingency_0 != 0) {
        ...
        cur_frm.set_value("markup_0", (markup_0 * 100));
        cur_frm.set_value("margin_0", (margin_0 * 100));
    },
    profit_1: function (frm) {
        ...
        cur_frm.set_value("markup_1", (markup_1 * 100));
        cur_frm.set_value("margin_1", (margin_1 * 100));
    },
    profit_2: function (frm) {
        ...
        cur_frm.set_value("markup_2", (markup_2 * 100));
        cur_frm.set_value("margin_2", (margin_2 * 100));
    },
    profit_3: function (frm) {
        ...
        cur_frm.set_value("markup_3", (markup_3 * 100));
        cur_frm.set_value("margin_3", (margin_3 * 100));
    },
    profit_4: function (frm) {
        ...
        cur_frm.set_value("markup_4", (markup_4 * 100));
        cur_frm.set_value("margin_4", (margin_4 * 100));
    },
    profit_5: function (frm) {
        ...
        cur_frm.set_value("markup_5", (markup_5 * 100));
        cur_frm.set_value("margin_5", (margin_5 * 100));
    },
    profit_6: function (frm) {
        ...
        cur_frm.set_value("markup_6", (markup_6 * 100));
        cur_frm.set_value("margin_6", (margin_6 * 100));
    },
    profit_7: function (frm) {
        ...
        cur_frm.set_value("markup_7", (markup_7 * 100));
        cur_frm.set_value("margin_7", (margin_7 * 100));
    },
    profit_8: function (frm) {
        ...
        cur_frm.set_value("markup_8", (markup_8 * 100));
        cur_frm.set_value("margin_8", (margin_8 * 100));
    },
    profit_9: function (frm) {
        ...
        cur_frm.set_value("markup_9", (markup_9 * 100));
        cur_frm.set_value("margin_9", (margin_9 * 100));
    },
    profit_10: function (frm) {
        ...
        cur_frm.set_value("markup_10", (markup_10 * 100));
        cur_frm.set_value("margin_10", (margin_10 * 100));
    },
    profit_11: function (frm) {
        ...
        cur_frm.set_value("markup_11", (markup_11 * 100));
        cur_frm.set_value("margin_11", (margin_11 * 100));
    },
    profit_12: function (frm) {
        ...
        cur_frm.set_value("markup_12", (markup_12 * 100));
        cur_frm.set_value("margin_12", (margin_12 * 100));
    },
    profit_13: function (frm) {
        ...
        cur_frm.set_value("markup_13", (markup_13 * 100));
        cur_frm.set_value("margin_13", (margin_13 * 100));
    },
    profit_14: function (frm) {
        ...
        cur_frm.set_value("markup_14", (markup_14 * 100));
        cur_frm.set_value("margin_14", (margin_14 * 100));
    },
    profit_15: function (frm) {
        ...
        cur_frm.set_value("markup_15", (markup_15 * 100));
        cur_frm.set_value("margin_15", (margin_15 * 100));
    },
    vat: function (frm) {
...
frappe.ui.form.on('Items Details', {
    ...
    selling_price: function (frm, cdt, cdn) {
        ...
        if (d.contingency + d.selling_price != 0) {
